...
func (x *RegisterReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.PasswordAgain, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *RegisterReq) fastWriteField3(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 3, x.GetPasswordAgain())
	return offset
}
...
func (x *RegisterReq) sizeField3() (n int) {
	...
	n += fastpb.SizeString(3, x.GetPasswordAgain())
	return n
}
